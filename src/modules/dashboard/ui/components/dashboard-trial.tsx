...
export const DashboardTrial = () => {
    ...
    return(
        <div className="bg-red-500/10 overflow-hidden  rounded-lg w-full flex flex-col gap-y-2">
            ...
            <Button 
                className="bg-transparent border-t border-border/10 hover:bg-red-500/20 rounded-t-none"
            asChild
            >
                <Link href="/upgrade" >
                Upgrade
